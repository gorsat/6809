...
140 PRINT
150 PRINT
160 Q=0:Z=0:X=INT((RND(100)/100)*H+1)
165 FOR I=1 TO H
170 IF I=X THEN 173
171 PRINT ".--";:GOTO 180
173 PRINT ".  ";
...
310 X=INT((RND(100)/100)*3+1)
320 ON X GOTO 790,820,860
330 IF S<>V THEN 340
334 IF Z=1 THEN 370
338 Q=1:GOTO 350
340 IF W(R,S+1)<>0 THEN 370
350 X=INT((RND(100)/100)*3+1)
360 ON X GOTO 790,820,910
370 X=INT((RND(100)/100)*2+1)
...
430 X=INT((RND(100)/100)*3+1)
440 ON X GOTO 790,860,910
450 X=INT((RND(100)/100)*2+1)
460 ON X GOTO 790,860
470 IF S<>V THEN 490
480 IF Z=1 THEN 520
485 Q=1:GOTO 500
490 IF W(R,S+1)<>0 THEN 520
500 X=INT((RND(100)/100)*2+1)
...
570 X=INT((RND(100)/100)*3+1)
580 ON X GOTO 820,860,910
590 X=INT((RND(100)/100)*2+1)
600 ON X GOTO 820,860
610 IF S<>V THEN 630
620 IF Z=1 THEN 660
625 Q=1:GOTO 640
630 IF W(R,S+1)<>0 THEN 660
640 X=INT((RND(100)/100)*2+1)
